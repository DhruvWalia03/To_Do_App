...
public class DataBaseHelper extends SQLiteOpenHelper {
    ...
    public Boolean insertData(task_to_be_done task) {
    ...
    public List<task_to_be_done> getAllData() {
        SQLiteDatabase db = this.getWritableDatabase();
        List<task_to_be_done> tasklist = new ArrayList<>();
        Cursor cur = null;
        db.beginTransaction();
        try {
            ...
            if (cur != null) {
                if (cur.moveToFirst()) {
                    do {
                        task_to_be_done task = new task_to_be_done
